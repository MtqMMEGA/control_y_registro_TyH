  ...
  <head>
	...
	$(document).ready(function() {
		$('form').submit(function(e) {
			e.preventDefault();
			$.getJSON('jsonT.php?' + $(this).serialize(), function(result) {
				...
				chart.render();
				JSONToCSVConvertor(result, "ConsultaT", true);
			});
		});
	});
	</script>
				...
				<ul class="nav navbar-nav">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li class="active"><a href="consultaT.php"><span class="glyphicon glyphicon-fire"></span> Consultar Temperatura</a></li>
