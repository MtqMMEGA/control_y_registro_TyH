<html lang="en">
  <head>
    ...
    <title>Consulta de Temperatura y Humedad</title>
	...
	$(document).ready(function() {
		$('form').submit(function(e) {
			...
			var datosT = [];
			var datosH = [];
			$.getJSON('jsonTyH.php?' + $(this).serialize(), function(result) {
				$.each(result, function(key, value){
                    var Ttemp = [];
                    var Htemp = [];
                    Ttemp = {label: value['label'], y: parseInt(value['y'])};
                    Htemp = {label: value['label'], y: parseInt(value['y2'])};
                    datosT.push(Ttemp);
                    datosH.push(Htemp);
                });
				...
				var chart = new CanvasJS.Chart("chartContainer",
				{
					...
					theme: "theme2",
					title:{
						text: "Consulta de Temperatura y Humedad"
					},
					axisX:
					{
						labelAngle: 90,
				...
				chart.render();
				JSONToCSVConvertor(result, "ConsultaTyH", true);
			});
		});
	});
	</script>
				...
				<ul class="nav navbar-nav">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="active"><a href="consulta.php"><span class="glyphicon  glyphicon-search"></span> Consultar Ambas</a></li>
						</ul>
					</li>
					<li class="dropdown">
...
<div class="container">
		<div class="page-header">	
			<h1>Consulta de Temperatura y Humedad</h1>
		</div>
