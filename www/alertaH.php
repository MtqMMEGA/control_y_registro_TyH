    ...
    document.body.removeChild(link);
		...
		$(document).ready(function() {
			$('form').submit(function(e) {
				...
				var datosHumedad = [];
				var datosHMax = [];
				$.getJSON('jsonAH.php?' + $(this).serialize(), function(result) {
				...
				console.log(datosHumedad);
					var chart = new CanvasJS.Chart("chartContainer",
					{
						...
						theme: "theme2",
						title:{
							text: "Consulta de Alertas de Humedad"
						},
						axisX:
				    	{
					    	labelAngle: 90,
					...
					chart.render();
					JSONToCSVConvertor(result, "AlertaH", true);
				});
			});
		});
	</script>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="active"><a href="alertaH.php"><span class="glyphicon glyphicon-tint"></span> Alertas Humedad</a></li>
							<li role="separator" class="divider"></li>
...
<div class="container">
		<div class="page-header">	
			<h1>Alertas de Humedad Registradas</h1>
		</div>
