    ...
    document.body.removeChild(link);
		...
		$(document).ready(function() {
			$('form').submit(function(e) {
				...
				var datosTemp = [];
				var datosTMax = [];
				$.getJSON('jsonAT.php?' + $(this).serialize(), function(result) {
				...
				console.log(datosTemp);
					var chart = new CanvasJS.Chart("chartContainer",
					{
						...
						theme: "theme2",
						title:{
							text: "Consulta de Alertas de Temperatura"
						},
						axisX:
					    {
    						labelAngle: 90,
					...
					chart.render();
					JSONToCSVConvertor(result, "AlertaT", true);
				});
			});
		});
	</script>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li class="active"><a href="alertaT.php"><span class="glyphicon glyphicon-fire"></span> Alertas Temperatura</a></li>
...
<div class="container">
		<div class="page-header">	
			<h1>Alertas de Temperatura Registradas</h1>
		</div>
