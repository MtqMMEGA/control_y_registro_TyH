...
void loop() 
{
  int T_MAX;
  int H_MAX;
  int intervalo_min; //intervalo en minutos
  ...
  else
  {
    ...
    delay(intervalo_min * 60000 - 10000);  
  }
}
...
/*---------- Devuelve el intervalo entre lecturas (en minutos) definido en la configuracion -----*/
int Intervalo()
{ 
    Process intevalo;
    intevalo.begin("python");
    intevalo.addParameter("/mnt/sda1/www/py/intervalo.py");
    intevalo.run();
    String intevalo_min = intevalo.readString(); // respuesta
    return intevalo_min.toInt();
